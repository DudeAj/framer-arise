      ...
      <g clip-path="url(#a)">
        <g clip-path="url(#b)">
          <rect
            ...
            fill="#06040B"
            rx="4.5"
            transform="rotate(38.263 351.982 260.408)"
          />
          <path
            fill="url(#c)"
            d="M309.396 314.403h19.885V462.71h-19.885z"
            transform="rotate(38.263 309.396 314.403)"
          />
          <path
            fill="url(#d)"
            d="M309.396 314.403h19.885V462.71h-19.885z"
          ...
          <path
            fill="#000B5C"
            d="m331.459 286.43 15.613 12.314-22.062 27.974-15.614-12.314z"
          />
          <g filter="url(#e)">
            <path
              fill="url(#f)"
              d="M351.982 260.408h19.885v64.625h-19.885z"
              transform="rotate(38.263 351.982 260.408)"
            />
          </g>
        </g>
        <g filter="url(#g)">
          <circle
            ...
            r="70.607"
            fill="#003BFF"
            transform="rotate(38.263 358.694 267.285)"
          />
        </g>
        <g filter="url(#h)">
          <circle
            ...
            r="25.326"
            fill="#fff"
            transform="rotate(38.263 346.865 282.134)"
          />
        </g>
        <path
          fill="url(#i)"
          d="M340.553 389.25H-.5v115.125h506.625c0-7.308-3.48-14.179-9.371-18.504L384.933 403.79a75.002 75.002 0 0 0-44.38-14.54z"
        />
        <path
          stroke="url(#j)"
          stroke-width=".75"
          d="M340.553 389.25H-.5v115.125h506.625c0-7.308-3.48-14.179-9.371-18.504L384.933 403.79a75.002 75.002 0 0 0-44.38-14.54z"
        />
        <path fill="url(#k)" d="M0 267h506v289H0z" />
      </g>
      <defs>
        <linearGradient
          id="c"
        ...
        >
          ...
          <feBlend in2="shape" result="effect1_innerShadow_2178_499" />
        </filter>
        <filter
          id="g"
          width="591.221"
        ...
        >
          ...
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
          <feGaussianBlur
            result="effect1_foregroundBlur_2178_499"
            stdDeviation="112.5"
          />
        </filter>
        <filter
