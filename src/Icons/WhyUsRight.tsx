      ...
      <g clip-path="url(#a)">
        <g clip-path="url(#b)">
          <rect
            ...
            fill="#06040B"
            rx="4.5"
            transform="scale(-1 1) rotate(38.263 -507.353 -250.343)"
          />
          <path
            fill="url(#c)"
            d="M0 0h19.885v148.307H0z"
            transform="scale(-1 1) rotate(38.263 -606.473 -284.728)"
          />
          <path
            fill="url(#d)"
            d="M0 0h19.885v148.307H0z"
          ...
          <path
            fill="#000B5C"
            d="m284.541 286.43-15.613 12.314 22.062 27.974 15.614-12.314z"
          />
          <g filter="url(#e)">
            <path
              fill="url(#f)"
              d="M0 0h19.885v64.625H0z"
              transform="scale(-1 1) rotate(38.263 -507.353 -250.343)"
            />
          </g>
        </g>
        <g filter="url(#g)">
          <circle
            ...
            r="70.607"
            fill="#003BFF"
            transform="scale(-1 1) rotate(38.263 -376.833 -303.698)"
          />
        </g>
        <g filter="url(#h)">
          <circle
            ...
            r="25.326"
            fill="#fff"
            transform="scale(-1 1) rotate(38.263 -492.06 -270.697)"
          />
        </g>
        <path
          fill="url(#i)"
          d="M275.447 389.25H616.5v115.125H109.875c0-7.308 3.48-14.179 9.371-18.504l111.821-82.081a75.002 75.002 0 0 1 44.38-14.54z"
        />
        <path
          stroke="url(#j)"
          stroke-width=".75"
        ...
        <path
          fill="url(#k)"
          d="M0 0h506v289H0z"
          transform="matrix(-1 0 0 1 616 267)"
        />
      </g>
      <defs>
        <linearGradient
        ...
        >
          ...
          <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
          <feGaussianBlur
            result="effect1_foregroundBlur_2178_500"
            stdDeviation="112.5"
          />
        </filter>
        <filter
